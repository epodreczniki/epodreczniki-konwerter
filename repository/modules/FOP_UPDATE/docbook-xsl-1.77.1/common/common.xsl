...
<xsl:template match="orderedlist/listitem" mode="item-number">
  ...
  <xsl:if test="parent::orderedlist/@inheritnum='inherit'
   ...
   <xsl:apply-templates select="." mode="item-prefix"/>
   <xsl:number value="$item-number" format="{$type}"/>
   <xsl:apply-templates select="." mode="item-postfix"/>
</xsl:template>

<xsl:template match="orderedlist" mode="item-prefix"/>

<xsl:template match="orderedlist" mode="item-postfix"/>

<xsl:template match="listitem" mode="item-prefix">
	<xsl:value-of select="@prefix"/>
</xsl:template>

<xsl:template match="listitem" mode="item-postfix">
