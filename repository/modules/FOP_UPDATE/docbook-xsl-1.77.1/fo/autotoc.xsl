...
<!-- ********************************************************************
     ...
     ******************************************************************** -->
<!-- 
This file has been modified in the scope of the www.epodreczniki.pl project by Tomasz Kuczynski tomasz.kuczynski@man.poznan.pl
-->
<!-- ==================================================================== -->
...
<xsl:template name="toc.line">
  ...
  <xsl:variable name="label">
	 <xsl:choose>
	  <xsl:when test="$override-label"><xsl:value-of select="$override-label"/></xsl:when>	 
      <xsl:when test="self::table"></xsl:when>
      <xsl:otherwise>
...
<xsl:template match="figure|example|equation|procedure" mode="toc">
  <xsl:param name="toc-context" select="."/>
  <xsl:call-template name="toc.line">
    <xsl:with-param name="toc-context" select="$toc-context"/>
  </xsl:call-template>
...
<xsl:template match="table" mode="toc">
  ...
  <xsl:for-each select="descendant::row[@role='ERROR']">
	  <xsl:variable name="override-label" select="entry[1]"/>
